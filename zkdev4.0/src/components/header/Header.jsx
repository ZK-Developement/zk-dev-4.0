...
function Header() {
    return (
        <header className="w-full h-[60px] flex items-center justify-center my-[29px] fixed z-[99]">
            <div className="lqglass rounded-[50px] flex w-fit max-w-[95%] h-[60px] items-center my-[29px] mx-[20px]  min-[1280px]:w-[1220px]
                ...
                max-[800px]:w-[100px]">
                    <img src={logonobg} alt="logo" className="h-[38px] w-[38px] mx-[10px]
                ...
                <nav className="flex h-[60px] items-center  min-[1280px]:ml-[470px] min-[800px]:ml-[280px]">
                    <ul className="flex items-center justify-center gap-[20px] text-[16px] font-normal whitespace-nowrap
                        ...
                        <li><a href="#" className="tekst-zmienny">O nas</a></li>
                        <li><a href="#" className="tekst-zmienny">Oferta</a></li>
                        <li><a href="#" className="tekst-zmienny">Pakiety</a></li>
                        <li><a href="#" className="tekst-zmienny">Portfolio</a></li>
                        <li><a href="#" className="tekst-zmienny">Kontakt</a></li>
                    </ul>
                </nav>
