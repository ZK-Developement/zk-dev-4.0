            ...
            >
                <div className="flex flex-col text-white w-[500px] pt-[35px]">
                    <div className="mb-[10px]">
                        ...
                        <p className="text-gray-400 mb-[15px] text-[16px] leading-5">Zanim rozpoczniemy programowanie, przygotowujemy wizualny projekt Twojej strony. Pokazujemy ci, jak będzie wyglądać gotowa realizacja, a następnie wspólnie ustalamy zmiany przed rozpoczęciem kodowania.</p>
                    </div>
