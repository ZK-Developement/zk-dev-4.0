    ...
    return(
        <section className=" w-[1280px] h-[401px] flex justify-center items-center mt-[30px]
                    ...
                    <div className="adaptive-bg bg-[radial-gradient(circle,_#393939,_#252525)] w-[1220px] h-[401px] rounded-[20px] shadow-[0_4px_30px_rgba(0,0,0,0.10)]
                                                   ...
                                                   max-[400px]:flex-col max-[400px]:w-[340px] max-[400px]:pt-[100px] max-[400px]:h-[450px] max-[400px]:bg-[length:100%_100%] max-[400px]:bg-center max-[400px]:pl-[20px]
                    ">
                        <div className="flex flex-col text-white w-[300px] pt-[35px] mb-auto max-[400px]:h-[240px] max-[400px]:translate-y-[-100px] ">
                            <div className="mb-[10px]">
                                <p className="text-[24px] font-semibold mb-[15px] max-[400px]:text-[20px] max-[400px]:w-[240px]"> Profesjonalna strona internetowa</p>
                                <p className="text-white opacity-50 mb-[15px] w-[500px] text-[16px] leading-5 max-[400px]:text-[14px] max-[400px]:leading-4 max-[400px]:w-[290px]">Używamy nowoczesnych technologii, aby tworzyć szybkie, funkcjonalne i dopracowane strony internetowe, które zapewniają wysoką jakość działania na każdym urządzeniu.</p>
                            </div>
                            <div className=" lqglass flex px-[17px] py-[11px] rounded-[20px] w-[490px] h-[52px] mb-[76px] gap-[20px] max-[400px]:mb-[26px] max-[400px]:h-[100px] max-[400px]:w-[300px] max-[400px]:hidden">
                        ...
                        <div className=" flex flex-col w-[690px] float-right items-center ml-auto max-[400px]:h-[300px] max-[400px]:translate-y-[-130px] max-[400px]:w-[300px] max-[400px]:ml-0">
                            <a href="#kontakt">
                            <div className="bg-[radial-gradient(circle,_#605E5E,_#FFFFFF)] flex w-[609px] h-[278px] rounded-3xl float-right mt-[83px] justify-center max-[400px]:w-[290px] max-[400px]:bg-[radial-gradient(circle,_#D2D2D2,_#FFFFFF)] max-[400px]:h-[130px]">
